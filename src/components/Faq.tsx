...
const questions = [
  ...
  {
    question: "كم تبلغ تكلفة الخدمات وهل توجد باقات؟",
    answer: "تتفاوت التكلفة حسب حجم نشاطك والسوق المستهدف. بعد الاستشارة المجانية نقدم عرضاً واضحاً بباقات شهرية مرنة تناسب الأنشطة الصغيرة والكبيرة — من دون أي التزامات خفية.",
  },
];
